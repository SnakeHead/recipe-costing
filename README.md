...
1. **Ingredients** — Add ketchup from Ben E. Keith: 6 units × 10 lb @ $75.23 → **$1.25/lb**.
2. **Invoices** (optional) — Upload a PDF/image or paste invoice text to import many items at once.
