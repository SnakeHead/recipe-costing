...
export function RecipeLineEditor({
  ...
  return (
    <div className="space-y-2">
      <div className="hidden gap-2 text-xs font-medium text-stone-500 sm:grid sm:grid-cols-[1fr_100px_80px_36px]">
      ...
      {lines.map((line, index) => (
        <div
          key={line.id}
          className="grid gap-2 rounded-lg border border-stone-100 bg-stone-50/50 p-2 sm:grid-cols-[1fr_100px_80px_36px] sm:items-center"
        >
          <div>
